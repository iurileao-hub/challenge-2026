...
**Divergências encontradas em relação à Frente 1** (citadas lá a partir de fontes secundárias; **ambas corrigidas na Frente 1 durante a revisão final**, registro mantido como histórico do método):

- A Frente 1 afirmava que o Corpo de Bombeiros "atualizou a IT-41 em novembro de 2025". **Impreciso.** Em 12/11/2025 a Portaria nº CCB-008/800/2025 apenas **abriu consulta pública** (30 dias) sobre a proposta de alteração; a atualização efetiva da IT-41 veio com a **Portaria nº CCB-003/970/2026, de 17/03/2026**, que incorporou os itens 5.2 a 5.12 — com diferenças de conteúdo em relação à minuta de novembro (ex.: DR 30 mA tipos A/F/B e homologação ANATEL só aparecem no texto final).
- A Frente 1 dizia que, pela Lei 18.403/2026, "a negativa agora exige laudo técnico fundamentado". O texto legal (art. 1º, § 2º) fala em *"justificativa técnica ou de segurança devidamente fundamentada e documentada"* — não exige formalmente um "laudo". Paráfrase próxima, ajustada para a expressão legal.
...
> **Nota de 22/09/2026: a vigência acima terminou.** A mesma consulta, refeita em 22/09/2026 com o filtro adicional `"DscDetalhe":"Não se aplica"` (arquivo gerado pela ANEEL em 2026-09-22), devolve como vigente a **RESOLUÇÃO HOMOLOGATÓRIA Nº 3.596, DE 3 DE JULHO DE 2026**, de 04/07/2026 a 03/07/2027: TUSD 472,42 + TE 316,96 = R$ 789,38/MWh ≈ **R$ 0,7894/kWh**, sem tributos. Resposta bruta em [`data/aneel_datastore_enelsp_b3_2026-09-22.json`](../data/aneel_datastore_enelsp_b3_2026-09-22.json). O texto acima fica como estava porque registra a consulta de junho. Na aplicação, o reajuste entrou como vigência nova (`TariffPeriod` a partir de 04/07/2026), sem reescrever a anterior: o mês fictício de junho continua a R$ 0,7252.
