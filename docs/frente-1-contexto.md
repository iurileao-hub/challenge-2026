...
Mapeamos cinco soluções existentes que tangenciam o problema do EV ChargeOps, escolhidas por cobrirem quadrantes diferentes do mercado: hardware premium europeu para edifícios (Zaptec), plataforma global integrada (ChargePoint), player nacional de condomínios (NeoCharge), rede pública de concessionária brasileira (Copel/Eletroposto Fácil) e carregador residencial conectado de protocolo aberto (Wallbox Pulsar Plus, nominalmente citado no enunciado do desafio).
...
### Wallbox Pulsar Plus (Espanha) — carregador residencial conectado

- **Problema que resolve:** recarga doméstica em vaga própria (casa ou vaga individual de condomínio) com app, agendamento e balanceamento de carga, sem upgrade da entrada elétrica.
- **Funcionalidades principais:** 7,4 kW (monofásico) a 11/22 kW (trifásico), modo 3 da IEC 61851-1, conector Type 1/Type 2; conectividade Wi-Fi e Bluetooth; identificação e controle pelo app e portal myWallbox; *Power Sharing* incluído e *Power Boost* / *Dynamic Power Sharing* opcionais para balanceamento; proteção por detecção de corrente residual integrada (30 mA AC / 6 mA DC); **compatível com OCPP 1.6J**, o que permite integrá-lo a sistemas de gestão de terceiros [Wallbox — Pulsar Plus Datasheet, 2021].
- **Modelo de negócio:** venda de hardware (no varejo brasileiro, por distribuidores independentes, na ordem de R$ 6–12 mil conforme a potência), com o app myWallbox gratuito para o usuário; recursos de gestão e cobrança multiusuário ficam a cargo da plataforma de negócios da Wallbox ou de software de terceiros via OCPP [pesquisa de mercado, 2026].
- **Limitações:** *análise da equipe:* o Pulsar Plus é, por posicionamento, um carregador **residencial de usuário único** — a própria Wallbox direciona condomínios e locais de trabalho ao modelo Pulsar Pro —, e o rateio condominial brasileiro (medição por morador, boleto, assembleia) **não é nativo do produto**, dependendo de uma camada de gestão externa. Em compensação, por ser **OCPP 1.6J aberto**, é exatamente o tipo de hardware que uma plataforma neutra como o EV ChargeOps gerencia sem lock-in — o oposto do OCPP parcial da Zaptec e da ausência de OCPP documentado da NeoCharge.

### Tabela comparativa

| Dimensão | Zaptec | ChargePoint | NeoCharge | Copel EV | Wallbox Pulsar Plus |
|---|---|---|---|---|---|
| **Problema que resolve** | Recarga coletiva em prédios europeus sem upgrade elétrico | Recarga em condomínios/HOAs com cobrança individual (EUA) | Recarga e rateio em condomínios e empresas brasileiras | Recarga pública em corredor rodoviário (PR) | Recarga residencial / vaga individual com app e balanceamento |
| **Funcionalidades principais** | Balanceamento dinâmico de carga/fases, portal cloud gratuito, medição MID, 2→1.000+ pontos | Power Sharing, dashboard cloud, cobrança direta ao morador + reembolso, perfis morador/visitante | Medição por usuário, rateio mensal, controle remoto de carregadores, app do usuário | Mapa + reserva de conector, recarga e custo em tempo real, 150 kW ultrarrápido | 7,4–22 kW modo 3, Type 1/2, app myWallbox, Power Sharing, **OCPP 1.6J** |
| **Modelo de negócio** | Venda de hardware; software incluso | Hardware + assinatura cloud + taxa por sessão (2026) | Hardware + assinatura da plataforma + serviços | Cobrança por minuto (R$ 0,44–5,82/min), pagamento via app parceiro | Venda de hardware (~R$ 6–12k); app grátis; gestão multiusuário externa |
| **Limitações conhecidas** | OCPP parcial: balanceamento só na nuvem proprietária; sem operação no BR* | Taxas por sessão mal recebidas (2026); solução condominial não opera no BR* | Sem OCPP/API documentados → lock-in vertical*; preço não público* | App 3,8/5 com eletropostos inativos; cobrança por minuto penaliza AC lento | Residencial single-user — a própria Wallbox direciona condomínio/trabalho ao Pulsar Pro; rateio condominial não nativo (depende de software externo)\* |
...
24. Wallbox — *Pulsar Plus Datasheet* (potências 7,4/11/22 kW, Type 1/2, Modo 3 da IEC 61851-1, Wi-Fi/Bluetooth, OCPP compatível, Power Sharing + Power Boost/Dynamic Power Sharing, DR 30 mA AC/6 mA DC, app myWallbox). Documento de 2021, acesso em 2026-06-20. https://support.wallbox.com/wp-content/uploads/2021/12/EN_Pulsar_Plus_Datasheet_English.pdf · Posicionamento para condomínio/local de trabalho (Pulsar Pro): https://wallbox.com/en_us/pulsar-pro-ev-charger · Disponibilidade e preço no varejo brasileiro: https://www.wechargeshop.com.br/carregadores/carregador-para-veiculo-eletrico-wallbox-pulsar-plus-7-4-kw

### Opção C — análise de dados públicos

Todas as fontes abaixo foram acessadas em 2026-06-09, salvo data indicada na própria entrada. Citações no texto: [ABVE, 2026] = fonte 25; [ABVE, 2026b] = fonte 27; [ABVE, 2022] = fonte 26.

25. ABVE — "Eletrificados crescem dez vezes mais do que o conjunto do mercado, e vendas chegam a 224 mil veículos em 2025" (emplacamentos 2025/2024/2016 e divisão BEV/PHEV/HEV; mesma fonte 1). https://abve.org.br/eletrificados-crescem-dez-vezes-mais-do-que-conjunto-do-mercado-em-2025-com-224-mil-veiculos-vendidos/
26. ABVE — "Eletrificados batem todas as previsões em 2021" (emplacamentos 2019–2021 e divisão por tecnologia em 2021). https://abve.org.br/eletrificados-batem-todas-as-previsoes-em-2021/
27. ABVE — "Recarga pública rápida cresce 167% em um ano e chega a 31% dos 21 mil eletropostos da rede" (rede fev/2025 e fev/2026 com divisão AC/DC, municípios por região, frota plug-in de 411.869, razão 19,6 veículos/ponto e referência 10:1). https://abve.org.br/recarga-publica-rapida-cresce-167-em-12-meses-e-ja-atinge-31-dos-21-mil-eletropostos-da-rede/
28. Fecombustíveis (reprodução de O Globo, 04/01/2024) — "Venda de carros eletrificados no Brasil cresce 91% em 2023 e atinge 93,9 mil emplacamentos" (emplacamentos 2022 e 2023, dados ABVE). https://www.fecombustiveis.org.br/noticia/venda-de-carros-eletrificados-no-brasil-cresce-91-em-2023-e-atinge-939-mil-emplacamentos/255655
29. ClimaInfo — "Pontos de recarga de VEs crescem 59% no Brasil, mas distribuição é desigual" (rede ago/2025 de 16.880 pontos e frota plug-in de 302.225, dados ABVE/Tupi). https://climainfo.org.br/2025/09/18/pontos-de-recarga-de-ves-crescem-59-no-brasil-mas-distribuicao-e-desigual/
30. Latam Mobility — "O Brasil alcança 16.880 pontos de recarga públicos e semipúblicos" (divisão AC/DC em 31/08/2025). https://latamobility.com/pt-br/o-brasil-alcanca-16-880-pontos-de-recarga-publicos-e-semipublicos-para-veiculos-eletricos/
31. AutoIndústria — "A nova geografia da recarga elétrica no Brasil" (SP com 4.777 pontos, 28,3%; SP+RJ+RS+DF com mais da metade da rede). https://www.autoindustria.com.br/2026/02/24/a-nova-geografia-da-recarga-eletrica-no-brasil/
32. Open Charge Map — espelho oficial `ocm-export` no GitHub (1.298 pontos de recarga no Brasil, georreferenciados; a API oficial exige chave gratuita, o espelho não). https://github.com/openchargemap/ocm-export
33. IBGE — API de localidades, lista oficial dos 5.571 municípios com UF e região. https://servicodados.ibge.gov.br/api/v1/localidades/municipios?view=nivelado
34. IEA — *Global EV Outlook 2025*, cap. 6 "Electric vehicle charging" — "Home charging remains the most popular way to charge for EV owners" (p. 98); pesquisas recentes indicam que mais de 85% dos donos de EV nos EUA têm acesso a recarga residencial (p. 115). Citação no texto: [IEA, 2025]. Acesso em 2026-06-10. https://www.iea.org/reports/global-ev-outlook-2025/electric-vehicle-charging · PDF íntegro: https://iea.blob.core.windows.net/assets/7ea38b60-3033-42a6-9589-71134f4229f4/GlobalEVOutlook2025.pdf
